...
async function testAPIs() {
  try {
    ...
    const professionalResponse = await axios.get('http://localhost:5000/api/professionals/684334cc016361b53a41404d');
    ...
    const productsResponse = await axios.get('http://localhost:5000/api/professionals/684334cc016361b53a41404d/products');
