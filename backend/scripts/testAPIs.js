...
async function testAPIs() {
  try {
    ...
    const professionalResponse = await axios.get('https://holistic-maroc-backend.onrender.com/api/professionals/684334cc016361b53a41404d');
    ...
    const productsResponse = await axios.get('https://holistic-maroc-backend.onrender.com/api/professionals/684334cc016361b53a41404d/products');
