  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            {navigation.map(item => {
              ...
              return (
                ...
                >
                  ...
                  {item.count > 0 && (
                    <span className="bg-red-100 text-red-600 text-xs rounded-full px-2 py-1 font-medium shadow-sm">
                      {item.count}
                    </span>
                  )}
                  {item.current && (
      ...
      <motion.div
        ...
        className="fixed inset-y-0 left-0 z-50 w-72 bg-white shadow-2xl transform lg:hidden"
      >
        {/* Sidebar header */}
        <div className="flex items-center justify-between h-16 px-6 bg-gradient-lotus relative overflow-hidden">
          {/* Background decoration */}
          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center text-sm">
                <span className="hidden sm:block text-gray-500">Connecté en tant qu'</span>
